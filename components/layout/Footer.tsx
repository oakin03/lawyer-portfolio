    ...
    <footer className="border-t border-neutral-200 bg-neutral-50 py-16">
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-4 sm:flex-row sm:flex-wrap sm:justify-between">
        ...
        <div className="mt-4 flex gap-3">
            ...
            className="group relative flex h-16 w-16 items-center justify-center overflow-hidden rounded-full border-2 border-burgundy bg-white"
            >
            ...
            <InstagramIcon
                size={24}
                className="relative z-10 text-burgundy transition-all duration-500 group-hover:text-white group-hover:[transform:rotateY(360deg)]"
            />
            </a>
